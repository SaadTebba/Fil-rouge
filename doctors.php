    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-5 h1reg">
                        <h1>Discover, Rate, and Empower Your Health with HealthHub: Your TrustedGuide to Top-rated Doctors in Your Area!</h1>
        ...
        <section class="container my-4">
            ...
            <article class="my-5 card-container d-flex justify-content-center">
                ...
                $statement = $conn->prepare("SELECT * FROM `doctors` ORDER BY `doctors`.`Rating` DESC");
                $statement->execute();
                    ...
                    <div class="card mx-2 mb-2" style="width: 19rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                ...
                                $review_doctor_id = $doctor['Doctor_ID'];
                            ...
                            <a href="review_doctor.php?id=<?php echo $review_doctor_id; ?>" class="btn review_button">Review</a>
                        </div>
                    </div>
