            ...
            <div class="signin-container">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="member_edit_profile.php">Edit profile</a></li>
                        <li>
            ...
            <div class="profile-container">
                ...
                <div class="col-3">
                    ...
                    <form method="POST" class="g-3 needs-validation">
                        ...
                        <label for="app_code" class="form-label">Your Appointment Code</label>
                        <input type="text" class="form-control" id="app_code" name="app_code" required>

                        <label for="comment" class="form-label">Your Comment</label>
                        <textarea class="form-control" id="comment" name="comment" rows="3" required></textarea>

                        <button class="btn col-12 submit_button mt-3" type="submit" name="submit">Submit</button>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $statement = $conn->prepare("INSERT INTO comments (Member_ID, Doctor_ID, Comment, Appointment_code) VALUES (?, ?, ?, ?)");
                        $statement->bindValue(1, $member_id);
                        $statement->bindValue(2, $doc_id_parameter);
                        $statement->bindValue(3, $comment);
                        $statement->bindValue(4, $app_code);
                        $statement->execute();
                    }
